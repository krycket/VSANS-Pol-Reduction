#This is set to for summer school 2020 VSANS data (1/15/2021).
input_path = r'VSANS27633_CoFe2O4NP_Data'
#input_path = r'VSANS26903_Fe3O4NP_Data'
...
Excluded_Filenumbers = [51286] #[Use filenumers separated by commas as needed]
ReAssignBlockBeam = []
ReAssignEmpty = []
ReAssignOpen = []
ReAssignSample = []
