input_path = r'C:/Users/klkry/Desktop/SummerSchool2020/SumerSchoolDownload/VSANS27633_CoFe2O4NP_Data'
save_path = r'C:/Users/klkry/Desktop/ToShare/CoFe2O4Data/'

#NG7 SANS Example:
#input_path = r'C:/Users/klkry/Desktop/LogBook/25227_Arena_Dec2018_NG7SANS'
#save_path = r'C:/Users/klkry/Desktop/ToShare/NG7Test/'
#exclude 77058, 77059, 77126, 77259
#max file number 77264
#need YesNoManualHe3Entry = 1
#need New_HE3_Files = [77070, 77297, 77566]
#need MuValues = [3.105, 3.374, 3.105]
#need TeValues = [0.86, 0.86, 0.86]


#Example where VSANS ASCII files work well with SasView 5.0.4
#input_path = r'C:/Users/klkry/Desktop/Logbook/25903_Almut_VSANSNov2019/'
#save_path = r'C:/Users/klkry/Desktop/ToShare/Almut/'
#Excluded_Filenumbers = [51421, 51422, 51375, 51378, 51464, 55181, 56704]
#New_HE3_Files = [51414]
#MuValues = [3.374]
#TeValues = [0.86]
...
Excluded_Filenumbers = [77058, 77059, 77126, 77259] #[Use filenumers separated by commas as needed]
ReAssignBlockBeam = []
ReAssignEmpty = []
ReAssignOpen = []
ReAssignSample = []
Min_Filenumber = 0 #Default 0
Max_Filenumber = 77264 #Default 1000000
...
SampleDescriptionKeywordsToExclude = ['Check']
